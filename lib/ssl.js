...
SSL.prototype.useListeningServer = function (listeningServer) {
  if (!listeningServer) throw new Error('Invalid listening server. Must be server running on port 80')
  if (listeningServer.port !== 80) throw new Error('Invalid listening server. Must be running on port 80')
