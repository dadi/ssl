...
const rsa = () => {
  return new RSA({b: 4096, e: 61537}, {signingScheme: 'SHA256'})//.generateKeyPair(4096, 65537)
 ...
 */
const fromStandardB64 = (x) => x.replace(/[+]/g, "-").replace(/\//g, "_").replace(/=/g,"")
...
const toStandardB64 = (x) => {
  let b64 = x.replace(/-/g, "+").replace(/_/g, "/").replace(/=/g, "")
