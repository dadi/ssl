...
const b64enc = (buffer = Buffer.from('')) => fromStandardB64(buffer.toString('base64'))
...
const b64EncodeBinaryString = str => {
  if (typeof str !== 'string') {
    throw new Error('b64EncodeBinaryString requires type of String')
  }
  return b64enc(toBinaryString(str.toString()))
}
